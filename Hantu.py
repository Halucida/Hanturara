...
class Modeler(Model):
    def __init__(self, output_node):
        ...
        self.conv_one = layers.Conv2D(16, 3, activation="relu", padding="same")
        self.conv_two = layers.Conv2D(32, 3, activation="relu", padding="same")
        self.conv_thr = layers.Conv2D(64, 3, activation="relu", padding="same")
      
        self.pool_img = layers.MaxPool2D((2, 2))
